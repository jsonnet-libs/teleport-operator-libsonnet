{
  ...
  spec: {
    ...
    options: {
      ...
      cert_extensions: {
        '#withMode':: d.fn(help='"Mode is the type of extension to be used -- currently critical-option is not supported"', args=[d.arg(name='mode', type=d.T.any)]),
        ...
        withName(name): { name: name },
        '#withType':: d.fn(help='"Type represents the certificate type being extended, only ssh is supported at this time."', args=[d.arg(name='type', type=d.T.any)]),
      ...
      '#withCreate_db_user_mode':: d.fn(help='"CreateDatabaseUserMode allows users to be automatically created on a database when not set to off."', args=[d.arg(name='create_db_user_mode', type=d.T.any)]),
      ...
      '#withCreate_host_user_mode':: d.fn(help='"CreateHostUserMode allows users to be automatically created on a host when not set to off"', args=[d.arg(name='create_host_user_mode', type=d.T.any)]),
      ...
      '#withRequire_session_mfa':: d.fn(help='"RequireMFAType is the type of MFA requirement enforced for this user."', args=[d.arg(name='require_session_mfa', type=d.T.any)]),
