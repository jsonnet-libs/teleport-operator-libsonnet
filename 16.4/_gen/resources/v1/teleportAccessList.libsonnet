{
  ...
  spec: {
    ...
    audit: {
      ...
      recurrence: {
        '#withDay_of_month':: d.fn(help='"day_of_month is the day of month that reviews will be scheduled on. Supported values are 0, 1, 15, and 31."', args=[d.arg(name='day_of_month', type=d.T.any)]),
        withDay_of_month(day_of_month): { spec+: { audit+: { recurrence+: { day_of_month: day_of_month } } } },
        '#withFrequency':: d.fn(help='"frequency is the frequency of reviews. This represents the period in months between two reviews. Supported values are 0, 1, 3, 6, and 12."', args=[d.arg(name='frequency', type=d.T.any)]),
