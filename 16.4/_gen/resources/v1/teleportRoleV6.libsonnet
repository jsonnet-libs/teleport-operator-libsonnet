{
  ...
  '#':: d.pkg(name='teleportRoleV6', url='', help='"RoleV6 is the Schema for the rolesv6 API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TeleportRoleV6', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
