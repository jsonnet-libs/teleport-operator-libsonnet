{
  ...
  '#':: d.pkg(name='teleportRoleV7', url='', help='"RoleV7 is the Schema for the rolesv7 API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TeleportRoleV7', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'resources.teleport.dev/v1',
    kind: 'TeleportRoleV7',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Role resource definition v7 from Teleport"'),
  spec: {
    '#allow':: d.obj(help='"Allow is the set of conditions evaluated to grant access."'),
    allow: {
      '#db_permissions':: d.obj(help='"DatabasePermissions specifies a set of permissions that will be granted to the database user when using automatic database user provisioning."'),
      db_permissions: {
        '#withMatch':: d.fn(help='"Match is a list of object labels that must be matched for the permission to be granted."', args=[d.arg(name='match', type=d.T.object)]),
        withMatch(match): { match: match },
        '#withMatchMixin':: d.fn(help='"Match is a list of object labels that must be matched for the permission to be granted."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='match', type=d.T.object)]),
        withMatchMixin(match): { match+: match },
        '#withPermissions':: d.fn(help='"Permission is the list of string representations of the permission to be given, e.g. SELECT, INSERT, UPDATE, ..."', args=[d.arg(name='permissions', type=d.T.array)]),
        withPermissions(permissions): { permissions: if std.isArray(v=permissions) then permissions else [permissions] },
        '#withPermissionsMixin':: d.fn(help='"Permission is the list of string representations of the permission to be given, e.g. SELECT, INSERT, UPDATE, ..."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='permissions', type=d.T.array)]),
      ...
      kubernetes_resources: {
        ...
        '#withVerbs':: d.fn(help='"Verbs are the allowed Kubernetes verbs for the following resource."', args=[d.arg(name='verbs', type=d.T.array)]),
        withVerbs(verbs): { verbs: if std.isArray(v=verbs) then verbs else [verbs] },
        '#withVerbsMixin':: d.fn(help='"Verbs are the allowed Kubernetes verbs for the following resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='verbs', type=d.T.array)]),
      ...
      request: {
        ...
        '#kubernetes_resources':: d.obj(help='"kubernetes_resources can optionally enforce a requester to request only certain kinds of kube resources. Eg: Users can make request to either a resource kind \\"kube_cluster\\" or any of its subresources like \\"namespaces\\". This field can be defined such that it prevents a user from requesting \\"kube_cluster\\" and enforce requesting any of its subresources."'),
        kubernetes_resources: {
          '#withKind':: d.fn(help='"kind specifies the Kubernetes Resource type."', args=[d.arg(name='kind', type=d.T.string)]),
          withKind(kind): { kind: kind },
        },
        ...
        '#withKubernetes_resources':: d.fn(help='"kubernetes_resources can optionally enforce a requester to request only certain kinds of kube resources. Eg: Users can make request to either a resource kind \\"kube_cluster\\" or any of its subresources like \\"namespaces\\". This field can be defined such that it prevents a user from requesting \\"kube_cluster\\" and enforce requesting any of its subresources."', args=[d.arg(name='kubernetes_resources', type=d.T.array)]),
        withKubernetes_resources(kubernetes_resources): { spec+: { allow+: { request+: { kubernetes_resources: if std.isArray(v=kubernetes_resources) then kubernetes_resources else [kubernetes_resources] } } } },
        '#withKubernetes_resourcesMixin':: d.fn(help='"kubernetes_resources can optionally enforce a requester to request only certain kinds of kube resources. Eg: Users can make request to either a resource kind \\"kube_cluster\\" or any of its subresources like \\"namespaces\\". This field can be defined such that it prevents a user from requesting \\"kube_cluster\\" and enforce requesting any of its subresources."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='kubernetes_resources', type=d.T.array)]),
        withKubernetes_resourcesMixin(kubernetes_resources): { spec+: { allow+: { request+: { kubernetes_resources+: if std.isArray(v=kubernetes_resources) then kubernetes_resources else [kubernetes_resources] } } } },
        '#withMax_duration':: d.fn(help='"MaxDuration is the amount of time the access will be granted for. If this is zero, the default duration is used."', args=[d.arg(name='max_duration', type=d.T.string)]),
        withMax_duration(max_duration): { spec+: { allow+: { request+: { max_duration: max_duration } } } },
      ...
      '#spiffe':: d.obj(help='"SPIFFE is used to allow or deny access to a role holder to generating a SPIFFE SVID."'),
      spiffe: {
        '#withDns_sans':: d.fn(help="\"DNSSANs specifies matchers for the SPIFFE ID DNS SANs.  Each requested DNS SAN is compared against all matchers configured and if any match, the condition is considered to be met.  The matcher by default allows '*' to be used to indicate zero or more of any character. Prepend '^' and append '$' to instead switch to matching using the Go regex syntax.  Example: *.example.com would match foo.example.com\"", args=[d.arg(name='dns_sans', type=d.T.array)]),
        withDns_sans(dns_sans): { dns_sans: if std.isArray(v=dns_sans) then dns_sans else [dns_sans] },
        '#withDns_sansMixin':: d.fn(help="\"DNSSANs specifies matchers for the SPIFFE ID DNS SANs.  Each requested DNS SAN is compared against all matchers configured and if any match, the condition is considered to be met.  The matcher by default allows '*' to be used to indicate zero or more of any character. Prepend '^' and append '$' to instead switch to matching using the Go regex syntax.  Example: *.example.com would match foo.example.com\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='dns_sans', type=d.T.array)]),
        withDns_sansMixin(dns_sans): { dns_sans+: if std.isArray(v=dns_sans) then dns_sans else [dns_sans] },
        '#withIp_sans':: d.fn(help='"IPSANs specifies matchers for the SPIFFE ID IP SANs.  Each requested IP SAN is compared against all matchers configured and if any match, the condition is considered to be met.  The matchers should be specified using CIDR notation, it supports IPv4 and IPv6.  Examples: - 10.0.0.0/24 would match 10.0.0.0 to 10.255.255.255 - 10.0.0.42/32 would match only 10.0.0.42"', args=[d.arg(name='ip_sans', type=d.T.array)]),
        withIp_sans(ip_sans): { ip_sans: if std.isArray(v=ip_sans) then ip_sans else [ip_sans] },
        '#withIp_sansMixin':: d.fn(help='"IPSANs specifies matchers for the SPIFFE ID IP SANs.  Each requested IP SAN is compared against all matchers configured and if any match, the condition is considered to be met.  The matchers should be specified using CIDR notation, it supports IPv4 and IPv6.  Examples: - 10.0.0.0/24 would match 10.0.0.0 to 10.255.255.255 - 10.0.0.42/32 would match only 10.0.0.42"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ip_sans', type=d.T.array)]),
        withIp_sansMixin(ip_sans): { ip_sans+: if std.isArray(v=ip_sans) then ip_sans else [ip_sans] },
        '#withPath':: d.fn(help="\"Path specifies a matcher for the SPIFFE ID path. It should not include the trust domain and should start with a leading slash.  The matcher by default allows '*' to be used to indicate zero or more of any character. Prepend '^' and append '$' to instead switch to matching using the Go regex syntax.  Example: - /svc/foo/*/bar would match /svc/foo/baz/bar - ^\\\\/svc\\\\/foo\\\\/.*\\\\/bar$ would match /svc/foo/baz/bar\"", args=[d.arg(name='path', type=d.T.string)]),
      ...
      '#withApp_labels_expression':: d.fn(help='"AppLabelsExpression is a predicate expression used to allow/deny access to Apps."', args=[d.arg(name='app_labels_expression', type=d.T.string)]),
      withApp_labels_expression(app_labels_expression): { spec+: { allow+: { app_labels_expression: app_labels_expression } } },
      ...
      '#withCluster_labels_expression':: d.fn(help='"ClusterLabelsExpression is a predicate expression used to allow/deny access to remote Teleport clusters."', args=[d.arg(name='cluster_labels_expression', type=d.T.string)]),
      withCluster_labels_expression(cluster_labels_expression): { spec+: { allow+: { cluster_labels_expression: cluster_labels_expression } } },
      ...
      '#withDb_labels_expression':: d.fn(help='"DatabaseLabelsExpression is a predicate expression used to allow/deny access to Databases."', args=[d.arg(name='db_labels_expression', type=d.T.string)]),
      withDb_labels_expression(db_labels_expression): { spec+: { allow+: { db_labels_expression: db_labels_expression } } },
      ...
      '#withDb_permissions':: d.fn(help='"DatabasePermissions specifies a set of permissions that will be granted to the database user when using automatic database user provisioning."', args=[d.arg(name='db_permissions', type=d.T.array)]),
      withDb_permissions(db_permissions): { spec+: { allow+: { db_permissions: if std.isArray(v=db_permissions) then db_permissions else [db_permissions] } } },
      '#withDb_permissionsMixin':: d.fn(help='"DatabasePermissions specifies a set of permissions that will be granted to the database user when using automatic database user provisioning."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='db_permissions', type=d.T.array)]),
      withDb_permissionsMixin(db_permissions): { spec+: { allow+: { db_permissions+: if std.isArray(v=db_permissions) then db_permissions else [db_permissions] } } },
      ...
      '#withDb_service_labels_expression':: d.fn(help='"DatabaseServiceLabelsExpression is a predicate expression used to allow/deny access to Database Services."', args=[d.arg(name='db_service_labels_expression', type=d.T.string)]),
      withDb_service_labels_expression(db_service_labels_expression): { spec+: { allow+: { db_service_labels_expression: db_service_labels_expression } } },
      ...
      '#withGroup_labels_expression':: d.fn(help='"GroupLabelsExpression is a predicate expression used to allow/deny access to user groups."', args=[d.arg(name='group_labels_expression', type=d.T.string)]),
      withGroup_labels_expression(group_labels_expression): { spec+: { allow+: { group_labels_expression: group_labels_expression } } },
      ...
      '#withKubernetes_labels_expression':: d.fn(help='"KubernetesLabelsExpression is a predicate expression used to allow/deny access to kubernetes clusters."', args=[d.arg(name='kubernetes_labels_expression', type=d.T.string)]),
      withKubernetes_labels_expression(kubernetes_labels_expression): { spec+: { allow+: { kubernetes_labels_expression: kubernetes_labels_expression } } },
      ...
      '#withNode_labels_expression':: d.fn(help='"NodeLabelsExpression is a predicate expression used to allow/deny access to SSH nodes."', args=[d.arg(name='node_labels_expression', type=d.T.string)]),
      withNode_labels_expression(node_labels_expression): { spec+: { allow+: { node_labels_expression: node_labels_expression } } },
      ...
      '#withSpiffe':: d.fn(help='"SPIFFE is used to allow or deny access to a role holder to generating a SPIFFE SVID."', args=[d.arg(name='spiffe', type=d.T.array)]),
      withSpiffe(spiffe): { spec+: { allow+: { spiffe: if std.isArray(v=spiffe) then spiffe else [spiffe] } } },
      '#withSpiffeMixin':: d.fn(help='"SPIFFE is used to allow or deny access to a role holder to generating a SPIFFE SVID."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='spiffe', type=d.T.array)]),
      withSpiffeMixin(spiffe): { spec+: { allow+: { spiffe+: if std.isArray(v=spiffe) then spiffe else [spiffe] } } },
      ...
      '#withWindows_desktop_labels_expression':: d.fn(help='"WindowsDesktopLabelsExpression is a predicate expression used to allow/deny access to Windows desktops."', args=[d.arg(name='windows_desktop_labels_expression', type=d.T.string)]),
      withWindows_desktop_labels_expression(windows_desktop_labels_expression): { spec+: { allow+: { windows_desktop_labels_expression: windows_desktop_labels_expression } } },
    ...
    deny: {
      ...
      request: {
        ...
        '#withKubernetes_resources':: d.fn(help='"kubernetes_resources can optionally enforce a requester to request only certain kinds of kube resources. Eg: Users can make request to either a resource kind \\"kube_cluster\\" or any of its subresources like \\"namespaces\\". This field can be defined such that it prevents a user from requesting \\"kube_cluster\\" and enforce requesting any of its subresources."', args=[d.arg(name='kubernetes_resources', type=d.T.array)]),
        withKubernetes_resources(kubernetes_resources): { spec+: { deny+: { request+: { kubernetes_resources: if std.isArray(v=kubernetes_resources) then kubernetes_resources else [kubernetes_resources] } } } },
        '#withKubernetes_resourcesMixin':: d.fn(help='"kubernetes_resources can optionally enforce a requester to request only certain kinds of kube resources. Eg: Users can make request to either a resource kind \\"kube_cluster\\" or any of its subresources like \\"namespaces\\". This field can be defined such that it prevents a user from requesting \\"kube_cluster\\" and enforce requesting any of its subresources."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='kubernetes_resources', type=d.T.array)]),
        withKubernetes_resourcesMixin(kubernetes_resources): { spec+: { deny+: { request+: { kubernetes_resources+: if std.isArray(v=kubernetes_resources) then kubernetes_resources else [kubernetes_resources] } } } },
        '#withMax_duration':: d.fn(help='"MaxDuration is the amount of time the access will be granted for. If this is zero, the default duration is used."', args=[d.arg(name='max_duration', type=d.T.string)]),
        withMax_duration(max_duration): { spec+: { deny+: { request+: { max_duration: max_duration } } } },
        '#withRoles':: d.fn(help='"Roles is the name of roles which will match the request rule."', args=[d.arg(name='roles', type=d.T.array)]),
      ...
      '#withApp_labels_expression':: d.fn(help='"AppLabelsExpression is a predicate expression used to allow/deny access to Apps."', args=[d.arg(name='app_labels_expression', type=d.T.string)]),
      withApp_labels_expression(app_labels_expression): { spec+: { deny+: { app_labels_expression: app_labels_expression } } },
      '#withAws_role_arns':: d.fn(help='"AWSRoleARNs is a list of AWS role ARNs this role is allowed to assume."', args=[d.arg(name='aws_role_arns', type=d.T.array)]),
      ...
      '#withCluster_labels_expression':: d.fn(help='"ClusterLabelsExpression is a predicate expression used to allow/deny access to remote Teleport clusters."', args=[d.arg(name='cluster_labels_expression', type=d.T.string)]),
      withCluster_labels_expression(cluster_labels_expression): { spec+: { deny+: { cluster_labels_expression: cluster_labels_expression } } },
      '#withDb_labels':: d.fn(help='"DatabaseLabels are used in RBAC system to allow/deny access to databases."', args=[d.arg(name='db_labels', type=d.T.object)]),
      withDb_labels(db_labels): { spec+: { deny+: { db_labels: db_labels } } },
      '#withDb_labelsMixin':: d.fn(help='"DatabaseLabels are used in RBAC system to allow/deny access to databases."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='db_labels', type=d.T.object)]),
      withDb_labelsMixin(db_labels): { spec+: { deny+: { db_labels+: db_labels } } },
      '#withDb_labels_expression':: d.fn(help='"DatabaseLabelsExpression is a predicate expression used to allow/deny access to Databases."', args=[d.arg(name='db_labels_expression', type=d.T.string)]),
      withDb_labels_expression(db_labels_expression): { spec+: { deny+: { db_labels_expression: db_labels_expression } } },
      '#withDb_names':: d.fn(help='"DatabaseNames is a list of database names this role is allowed to connect to."', args=[d.arg(name='db_names', type=d.T.array)]),
      ...
      '#withDb_permissions':: d.fn(help='"DatabasePermissions specifies a set of permissions that will be granted to the database user when using automatic database user provisioning."', args=[d.arg(name='db_permissions', type=d.T.array)]),
      withDb_permissions(db_permissions): { spec+: { deny+: { db_permissions: if std.isArray(v=db_permissions) then db_permissions else [db_permissions] } } },
      '#withDb_permissionsMixin':: d.fn(help='"DatabasePermissions specifies a set of permissions that will be granted to the database user when using automatic database user provisioning."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='db_permissions', type=d.T.array)]),
      withDb_permissionsMixin(db_permissions): { spec+: { deny+: { db_permissions+: if std.isArray(v=db_permissions) then db_permissions else [db_permissions] } } },
      '#withDb_roles':: d.fn(help='"DatabaseRoles is a list of databases roles for automatic user creation."', args=[d.arg(name='db_roles', type=d.T.array)]),
      ...
      '#withDb_service_labels_expression':: d.fn(help='"DatabaseServiceLabelsExpression is a predicate expression used to allow/deny access to Database Services."', args=[d.arg(name='db_service_labels_expression', type=d.T.string)]),
      withDb_service_labels_expression(db_service_labels_expression): { spec+: { deny+: { db_service_labels_expression: db_service_labels_expression } } },
      '#withDb_users':: d.fn(help='"DatabaseUsers is a list of databases users this role is allowed to connect as."', args=[d.arg(name='db_users', type=d.T.array)]),
      ...
      '#withGroup_labels_expression':: d.fn(help='"GroupLabelsExpression is a predicate expression used to allow/deny access to user groups."', args=[d.arg(name='group_labels_expression', type=d.T.string)]),
      withGroup_labels_expression(group_labels_expression): { spec+: { deny+: { group_labels_expression: group_labels_expression } } },
      '#withHost_groups':: d.fn(help='"HostGroups is a list of groups for created users to be added to"', args=[d.arg(name='host_groups', type=d.T.array)]),
      ...
      '#withKubernetes_labels_expression':: d.fn(help='"KubernetesLabelsExpression is a predicate expression used to allow/deny access to kubernetes clusters."', args=[d.arg(name='kubernetes_labels_expression', type=d.T.string)]),
      withKubernetes_labels_expression(kubernetes_labels_expression): { spec+: { deny+: { kubernetes_labels_expression: kubernetes_labels_expression } } },
      '#withKubernetes_resources':: d.fn(help='"KubernetesResources is the Kubernetes Resources this Role grants access to."', args=[d.arg(name='kubernetes_resources', type=d.T.array)]),
      ...
      '#withNode_labels_expression':: d.fn(help='"NodeLabelsExpression is a predicate expression used to allow/deny access to SSH nodes."', args=[d.arg(name='node_labels_expression', type=d.T.string)]),
      withNode_labels_expression(node_labels_expression): { spec+: { deny+: { node_labels_expression: node_labels_expression } } },
      '#withRequire_session_join':: d.fn(help='"RequireSessionJoin specifies policies for required users to start a session."', args=[d.arg(name='require_session_join', type=d.T.array)]),
      ...
      '#withSpiffe':: d.fn(help='"SPIFFE is used to allow or deny access to a role holder to generating a SPIFFE SVID."', args=[d.arg(name='spiffe', type=d.T.array)]),
      withSpiffe(spiffe): { spec+: { deny+: { spiffe: if std.isArray(v=spiffe) then spiffe else [spiffe] } } },
      '#withSpiffeMixin':: d.fn(help='"SPIFFE is used to allow or deny access to a role holder to generating a SPIFFE SVID."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='spiffe', type=d.T.array)]),
      withSpiffeMixin(spiffe): { spec+: { deny+: { spiffe+: if std.isArray(v=spiffe) then spiffe else [spiffe] } } },
      '#withWindows_desktop_labels':: d.fn(help='"WindowsDesktopLabels are used in the RBAC system to allow/deny access to Windows desktops."', args=[d.arg(name='windows_desktop_labels', type=d.T.object)]),
      ...
      '#withWindows_desktop_labels_expression':: d.fn(help='"WindowsDesktopLabelsExpression is a predicate expression used to allow/deny access to Windows desktops."', args=[d.arg(name='windows_desktop_labels_expression', type=d.T.string)]),
      withWindows_desktop_labels_expression(windows_desktop_labels_expression): { spec+: { deny+: { windows_desktop_labels_expression: windows_desktop_labels_expression } } },
      '#withWindows_desktop_logins':: d.fn(help='"WindowsDesktopLogins is a list of desktop login names allowed/denied for Windows desktops."', args=[d.arg(name='windows_desktop_logins', type=d.T.array)]),
    ...
    options: {
      ...
      cert_extensions: {
        '#withMode':: d.fn(help='"Mode is the type of extension to be used -- currently critical-option is not supported. 0 is \\"extension\\"."', args=[d.arg(name='mode', type=d.T.any)]),
        ...
        withName(name): { name: name },
        '#withType':: d.fn(help='"Type represents the certificate type being extended, only ssh is supported at this time. 0 is \\"ssh\\"."', args=[d.arg(name='type', type=d.T.any)]),
      ...
      '#withCreate_db_user_mode':: d.fn(help='"CreateDatabaseUserMode allows users to be automatically created on a database when not set to off. 0 is \\"unspecified\\", 1 is \\"off\\", 2 is \\"keep\\", 3 is \\"best_effort_drop\\"."', args=[d.arg(name='create_db_user_mode', type=d.T.any)]),
      withCreate_db_user_mode(create_db_user_mode): { spec+: { options+: { create_db_user_mode: create_db_user_mode } } },
      ...
      '#withCreate_host_user':: d.fn(help='"Deprecated: use CreateHostUserMode instead."', args=[d.arg(name='create_host_user', type=d.T.boolean)]),
      withCreate_host_user(create_host_user): { spec+: { options+: { create_host_user: create_host_user } } },
      '#withCreate_host_user_default_shell':: d.fn(help='"CreateHostUserDefaultShell is used to configure the default shell for newly provisioned host users."', args=[d.arg(name='create_host_user_default_shell', type=d.T.string)]),
      withCreate_host_user_default_shell(create_host_user_default_shell): { spec+: { options+: { create_host_user_default_shell: create_host_user_default_shell } } },
      '#withCreate_host_user_mode':: d.fn(help='"CreateHostUserMode allows users to be automatically created on a host when not set to off. 0 is \\"unspecified\\"; 1 is \\"off\\"; 2 is \\"drop\\" (removed for v15 and above), 3 is \\"keep\\"; 4 is \\"insecure-drop\\"."', args=[d.arg(name='create_host_user_mode', type=d.T.any)]),
      withCreate_host_user_mode(create_host_user_mode): { spec+: { options+: { create_host_user_mode: create_host_user_mode } } },
      ...
      '#withDevice_trust_mode':: d.fn(help='"DeviceTrustMode is the device authorization mode used for the resources associated with the role. See DeviceTrust.Mode."', args=[d.arg(name='device_trust_mode', type=d.T.string)]),
      ...
      '#withMfa_verification_interval':: d.fn(help="\"MFAVerificationInterval optionally defines the maximum duration that can elapse between successive MFA verifications. This variable is used to ensure that users are periodically prompted to verify their identity, enhancing security by preventing prolonged sessions without re-authentication when using tsh proxy * derivatives. It's only effective if the session requires MFA. If not set, defaults to `max_session_ttl`.\"", args=[d.arg(name='mfa_verification_interval', type=d.T.string)]),
      withMfa_verification_interval(mfa_verification_interval): { spec+: { options+: { mfa_verification_interval: mfa_verification_interval } } },
      ...
      '#withRequest_access':: d.fn(help='"RequestAccess defines the request strategy (optional|note|always) where optional is the default."', args=[d.arg(name='request_access', type=d.T.string)]),
      withRequest_access(request_access): { spec+: { options+: { request_access: request_access } } },
      '#withRequest_prompt':: d.fn(help='"RequestPrompt is an optional message which tells users what they aught to request."', args=[d.arg(name='request_prompt', type=d.T.string)]),
      withRequest_prompt(request_prompt): { spec+: { options+: { request_prompt: request_prompt } } },
      '#withRequire_session_mfa':: d.fn(help='"RequireMFAType is the type of MFA requirement enforced for this user. 0 is \\"OFF\\", 1 is \\"SESSION\\", 2 is \\"SESSION_AND_HARDWARE_KEY\\", 3 is \\"HARDWARE_KEY_TOUCH\\", 4 is \\"HARDWARE_KEY_PIN\\", 5 is \\"HARDWARE_KEY_TOUCH_AND_PIN\\"."', args=[d.arg(name='require_session_mfa', type=d.T.any)]),
